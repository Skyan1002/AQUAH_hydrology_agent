...
def precipitation_processor(args):
    download_mrms_precipitation(args.time_start, args.time_end, args.mrms_data_path)
    process_mrms_grib2_to_tif(args.mrms_data_path, args.crest_input_mrms_path, args.basin_shp_path, args.num_processes)
