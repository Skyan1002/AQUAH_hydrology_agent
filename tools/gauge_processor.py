...
def download_usgs_data(site_code, start_date=None, end_date=None, output_dir='../USGS_gauge/'):
    """
...
def gauge_processor(args):
    ...
    df_usgs = download_usgs_data(args.gauge_id, args.time_start, args.time_end, args.usgs_data_path)
